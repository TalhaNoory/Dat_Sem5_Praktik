module.exports = {
    ...
    orders: [{
        ...
        billingEmail: 'Paul@hotmail.dk',
        billingName: 'Paul Phoenix',
        billingCompany: 'Firma 1',
        billingAddress: 'Firmavej 1',
        billingCity: 'Firmaby 1',
        billingPostCode: '0000',
        billingState: null,
        billingCountry: 'Danmark',
        shippingName: 'Erik Hansen',
        shippingCompany: 'Firma 2',
        shippingAddress: 'Firmavej 2',
        shippingCity: 'Firmaby 2',
        shippingPostCode: '0001',
        shippingState: null,
